...
<html>
  ...
  <body onLoad()="callMessage('${message }')">
    <div id="accesszone">
      ...
      <div class="inputzone">
        <div id="general" class="choiceOn" onClick="callType(this)">
          General
        </div>
        <div id="restaurant" class="choiceOff" onClick="callType(this)">
          Restaurant
        </div>
    ...
    <div>
      아이디 분실 | 비밀번호 분실 |
      <a href="//192.168.1.190/signin.jsp">회원가입</a>>
    </div>
  </body>
</html>
